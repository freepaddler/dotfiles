...
printf 'resticprofile\n' > "$FIXTURE_SRC/private_dot_config/shell/rc/resticprofile"
...
printf 'resticprofile\n' > "$FIXTURE_HOME/.config/shell/rc/resticprofile"
...
assert_file_exists "$PUBLIC_HOME/.config/shell/rc/resticprofile" "public chezmoi apply should include explicit resticprofile wrapper"
assert_file_exists "$SSH_COPY_HOME/.config/shell/rc/resticprofile" "ssh-cp-env should include explicit resticprofile wrapper"
